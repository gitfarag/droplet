            ...
            <div class="text-center text-xxl-start">
              ...
              >
                <div class="text-uppercase">
                  Simplicity &middot; Always &middot; Wins
                </div>
              </div>
          ...
          <div class="col-xxl-8">
            <div class="text-center my-5">
              ...
              <p class="lead fw-light mb-4">
                My name is Ahmed Farag and I help brands grow.
              </p>
              <p class="text-muted">
                Advanced Full-stack Developer with a demonstrated knowlge in
                Vue.js, Node.js, Nest.js and Express.js. Skilled in JavaScript
                and TypeScript, Bachelor's degree focused in Computer Science
                from Faculty Of computer and information, Mansoura University .
              </p>
